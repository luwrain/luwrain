...
public class SingleLineEditTest extends Assert
{
	...
	model.hotPoint = 5;
	//typing 'a' on '5'
	assertTrue(edit.onInputEvent(new KeyboardEvent('a')));
	assertTrue(model.text.equals("01234a56789"));
	assertTrue(model.hotPoint == 6);
	//backspace
	assertTrue(edit.onInputEvent(new KeyboardEvent(KeyboardEvent.Special.BACKSPACE)));
	assertTrue(model.text.equals("0123456789"));
	assertTrue(model.hotPoint == 5);
	//delete
	assertTrue(edit.onInputEvent(new KeyboardEvent(KeyboardEvent.Special.DELETE)));
	assertTrue(model.text.equals("012346789"));
	assertTrue(model.hotPoint == 5);
	//home
	assertTrue(edit.onInputEvent(new KeyboardEvent(KeyboardEvent.Special.HOME)));
	assertTrue(model.text.equals("012346789"));

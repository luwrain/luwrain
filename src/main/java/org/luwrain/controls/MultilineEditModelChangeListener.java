...
/**
 * Implements a listener of all changes in {@link
 * MultilineEditModel}. This class contains the abstract method {
 * @code onMultilineEditChange} called each time when any changes are made in

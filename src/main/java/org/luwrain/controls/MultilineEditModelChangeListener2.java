 ...
 * @see MultilineEdit
 */
abstract public class MultilineEditModelChangeListener2 implements MultilineEdit.Model
{
    private final MultilineEdit.Model model;

    public MultilineEditModelChangeListener2(MultilineEdit.Model model)
    {

...
public class StandardElements
{
    ...
    static public final Element KEYBOARD = new SimpleElement(ROOT, SimpleElement.class.getName() + ":KEYBOARD");
    static public final Element SOUNDS = new SimpleElement(ROOT, SimpleElement.class.getName() + ":SOUNDS");
    static public final Element BRAILLE = new SimpleElement(ROOT, SimpleElement.class.getName() + ":BRAILLE");
    static public final Element SPEECH = new SimpleElement(ROOT, SimpleElement.class.getName() + ":SPEECH");
